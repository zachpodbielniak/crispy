...
:PROPERTIES:
:CUSTOM_ID: crispy-configuration
:END:
** Overview
:PROPERTIES:
:CUSTOM_ID: overview
...
:PROPERTIES:
:CUSTOM_ID: config-file-search-order
:END:
...
:PROPERTIES:
:CUSTOM_ID: bypassing-configuration
:END:
...
:PROPERTIES:
:CUSTOM_ID: config-file-structure
:END:
...
:PROPERTIES:
:CUSTOM_ID: crispy_params-in-config-files
:END:
...
:PROPERTIES:
:CUSTOM_ID: per-script-conditionals
:END:
...
:PROPERTIES:
:CUSTOM_ID: plugin-configuration-data
:END:
...
:PROPERTIES:
:CUSTOM_ID: crispys-own-arguments
:END:
